...
#define THRESHOLD_DELTA_ENCODERS 100 // ((MOTOR_OUTPUT_SHAFT_MAX_RPM / 60) * ENCODERS_COUNTABLE_EVENTS_OUTPUT_SHAFT) * ODOM_PERIOD
#define MAX_DELTA_POSE 0.0055 // ((MOTOR_OUTPUT_SHAFT_MAX_RPM / 60) * 2 * M_PI * WHEEL_RADIUS) / ODOM_RATE
